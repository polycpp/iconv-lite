...
C++ port of [iconv-lite](https://www.npmjs.com/package/iconv-lite) for [polycpp](https://github.com/enricohuang/polycpp).
...
- This repo does not imply full parity with upstream `iconv-lite`.
