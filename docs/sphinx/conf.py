# Sphinx configuration for the iconv-lite companion library.
#
...
html_theme_options = {
    ...
    'source_repository': 'https://github.com/polycpp/iconv-lite',
...
html_baseurl = 'https://polycpp.github.io/iconv-lite/'
